...
#elif defined(USE_RVV) && !defined(TF_LITE_STATIC_MEMORY)
#include "tflite/kernels/internal/reference/portable_tensor_utils.h"  // TODO: replace with rvv_tensor_utils.h when available
#else
